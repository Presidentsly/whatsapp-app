...
<!-- Emoji legördülő menü -->
<select id="emojiSelect">
    <option value="">Válassz egy emojit…</option>
</select>
...
// Több száz emoji (csak a kiválasztott kerül a mezőbe)
const emojis = [
"😀","😃","😄","😁","😆","😅","😂","🤣","🥲","☺️","😊","😇","🙂","🙃","😉",
"😍","🥰","😘","😗","😙","😚","😋","😛","😝","😜","🤪","🤨","🧐","🤓",
"😎","🥸","🤩","🥳","😏","😒","😞","😔","😟","😕","🙁","☹️","😣","😖","😫",
...
// Kiválasztott emoji az üzenetmezőbe
